...
This app utilizes [unproductive's League Proxy library](https://github.com/user334/LeagueProxyLib), which I forked to add support for macOS. The only modification made was in `RiotClient.cs`, where I adjusted file path checks for macOS compatibility.
